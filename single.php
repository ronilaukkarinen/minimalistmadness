        ...
        <article class="entry-content">
          ...
          <div class="author-info">
            ...
            <div class="author-col author-col-info">
              ...
              <p class="description">Kirjoittaja on <?php echo esc_attr( khonsu_calculate_age( '1988/11/01' ) ); ?>-vuotias elämäntapanörtti, ammatiltaan yrittäjä ja teknologiajohtaja perustamassaan <a href="https://www.dude.fi" class="author-link">digitoimistossa</a>, verkkosivujen tekijä, koukussa kirjoittamiseen 5-vuotiaasta. Päivät kuluu <a href="https://twitter.com/streetlazer" class="author-link">monipuolisen</a> <a href="https://www.last.fm/user/rolle-" class="author-link">musiikkiharrastuksen</a>, retropelien ja koodaamisen parissa, mutta arkea piristyttää myös vaimo ja kaksi lasta. <a href="http://twitter.com/rolle" target="_blank" class="author-link">Twitter</a>, <a href="http://www.rollemaa.fi/leffat" class="author-link">leffat</a> ja <a href="http://www.huurteinen.fi" target="_blank" class="author-link">erikoisoluet</a> lähellä sydäntä.</p>
