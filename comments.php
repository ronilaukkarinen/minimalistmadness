    ...
    <h2 class="comments-title">
      <?php
        ...
        if ( '1' === $comment_count ) {
          printf(
            /* translators: 1: title. */
            esc_html__( 'One thought on &ldquo;%1$s&rdquo;', 'minimalistmadness' ),
            '<span>' . esc_html( get_the_title() ) . '</span>'
          );
        } else {
        printf( // WPCS: XSS OK.
          /* translators: 1: comment count number, 2: title. */
          esc_html( _nx( '%1$s comment %2$s', '%1$s comments %2$s', $comment_count, 'comments title', 'minimalistmadness' ) ),
