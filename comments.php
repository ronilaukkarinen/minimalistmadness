      ...
      <div id="comment-<?php comment_ID(); ?>">
        ...
        <p class="comment-time">
          <a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ); // WPCS: XSS OK. ?>">
            ...
            <time><?php echo get_comment_date( 'j.', $comment_ID ); ?> <?php echo get_comment_date( 'F', $comment_ID ); ?>ta, <?php echo get_comment_date( 'Y', $comment_ID ); ?></time> <?php edit_comment_link( __( '&mdash; Muokkaa' ), ' ', '' ); ?>
          </a>
        </p>
