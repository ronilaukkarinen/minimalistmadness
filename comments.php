    ...
    <li id="li-comment-<?php comment_ID() ?>" <?php comment_class(); ?>>
      <div id="comment-<?php comment_ID(); ?>">
        ...
        <p class="comment-time">
          <a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ); // phpcs:ignore ?>">
            ...
            <time><?php echo esc_attr( get_comment_date( 'j.', $comment->comment_ID ) ); ?> <?php echo esc_attr( get_comment_date( 'F', $comment->comment_ID ) ); ?>ta, <?php echo esc_attr( get_comment_date( 'Y', $comment->comment_ID ) ); ?></time> <?php edit_comment_link( __( '&mdash; Muokkaa' ), ' ', '' ); ?>
          </a>
        </p>
