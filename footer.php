    ...
    <div class="container">
      <div class="footer-space">
        <ul class="social-media">
          ...
          <li><a class="no-external-link-indicator" href="https://mstdn.social/@rolle"><span class="screen-reader-text">Mastodon</span><?php include get_theme_file_path( '/svg/mastodon.svg' ); ?></a></li>
        </ul>
